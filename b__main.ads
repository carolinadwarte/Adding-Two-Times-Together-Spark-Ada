...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#2147c145#;
   ...
   u00105 : constant Version_32 := 16#2cc296e2#;
   pragma Export (C, u00105, "as_io_wrapperB");
   u00106 : constant Version_32 := 16#2503c2be#;
   pragma Export (C, u00106, "as_io_wrapperS");
   ...
   u00125 : constant Version_32 := 16#b8b74b70#;
   pragma Export (C, u00125, "sparkS");
   u00126 : constant Version_32 := 16#5b4c97f2#;
   pragma Export (C, u00126, "spark__text_ioB");
   u00127 : constant Version_32 := 16#7a20df73#;
   pragma Export (C, u00127, "spark__text_ioS");
   u00128 : constant Version_32 := 16#1716c23c#;
   pragma Export (C, u00128, "spark__text_io__integer_ioB");
   u00129 : constant Version_32 := 16#a85c384e#;
   pragma Export (C, u00129, "spark__text_io__integer_ioS");
   u00130 : constant Version_32 := 16#ba001e29#;
   pragma Export (C, u00130, "system__img_biuS");
   u00131 : constant Version_32 := 16#f75ed9f7#;
   pragma Export (C, u00131, "system__img_llbS");
   u00132 : constant Version_32 := 16#98c6c945#;
   pragma Export (C, u00132, "system__img_lliS");
   u00133 : constant Version_32 := 16#80af2c85#;
   pragma Export (C, u00133, "system__img_lllbS");
   u00134 : constant Version_32 := 16#f316ccbd#;
   pragma Export (C, u00134, "system__img_llliS");
   u00135 : constant Version_32 := 16#8adb3589#;
   pragma Export (C, u00135, "system__img_lllwS");
   u00136 : constant Version_32 := 16#ab6cacfc#;
   pragma Export (C, u00136, "system__img_llwS");
   u00137 : constant Version_32 := 16#85daa51b#;
   pragma Export (C, u00137, "system__img_wiuS");
   u00138 : constant Version_32 := 16#236b2bc2#;
   pragma Export (C, u00138, "system__val_intS");
   u00139 : constant Version_32 := 16#28959a26#;
   pragma Export (C, u00139, "system__val_unsS");
   u00140 : constant Version_32 := 16#6e5eba19#;
   pragma Export (C, u00140, "system__val_llliS");
   u00141 : constant Version_32 := 16#750441df#;
   pragma Export (C, u00141, "system__val_llluS");
   u00142 : constant Version_32 := 16#83790091#;
   pragma Export (C, u00142, "clockB");
   u00143 : constant Version_32 := 16#b34c5954#;
   pragma Export (C, u00143, "clockS");
   u00144 : constant Version_32 := 16#eca5ecae#;
   pragma Export (C, u00144, "system__memoryB");
   u00145 : constant Version_32 := 16#fba7f029#;
